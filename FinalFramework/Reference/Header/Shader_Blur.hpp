...
PS_OUT PS_HORIZONTAL_BLUR(PS_IN In)
{
	...
	f2TexUV1 = In.vTexUV + float2(fTexelWidthSize * -4.f, 0.f);
	f2TexUV2 = In.vTexUV + float2(fTexelWidthSize * -3.f, 0.f);
	f2TexUV3 = In.vTexUV + float2(fTexelWidthSize * -2.f, 0.f);
	f2TexUV4 = In.vTexUV + float2(fTexelWidthSize * -1.f, 0.f);
	f2TexUV5 = In.vTexUV + float2(fTexelWidthSize * 0.f, 0.f);
	f2TexUV6 = In.vTexUV + float2(fTexelWidthSize * 1.f, 0.f);
	f2TexUV7 = In.vTexUV + float2(fTexelWidthSize * 2.f, 0.f);
	f2TexUV8 = In.vTexUV + float2(fTexelWidthSize * 3.f, 0.f);
	f2TexUV9 = In.vTexUV + float2(fTexelWidthSize * 4.f, 0.f);
