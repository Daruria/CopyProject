...
public:
	...
	LPDIRECT3DTEXTURE9			Get_TargetTexture(LPDIRECT3DTEXTURE9 pOut = nullptr) { if (pOut) return pOut = m_pTargetTexture; return m_pTargetTexture; }
