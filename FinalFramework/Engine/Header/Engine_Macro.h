...
namespace Engine
{
	...
	{ ::MessageBoxW(NULL, L"Failed", L"System Error",MB_OK);  __debugbreak();/*__asm { int 3 };*/ return ;}
#endif
	...
	{ ::MessageBoxW(NULL, _message, L"System Message",MB_OK);  __debugbreak();/*__asm { int 3 };*/return ;}
#endif
