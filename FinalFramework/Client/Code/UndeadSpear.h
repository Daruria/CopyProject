#ifndef GUndeadSpear_h__
#define GUndeadSpear_h__
...
class CUndeadSpear : public CWeapon
{
private:
	explicit CUndeadSpear(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CUndeadSpear();
...
public:
	static CUndeadSpear* Create(LPDIRECT3DDEVICE9 pGraphicDev);

private:
	virtual void Free() override;
};

#endif // GUndeadSpear_h__
