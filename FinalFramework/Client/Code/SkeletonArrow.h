#ifndef SkeletonArrow_h__
#define SkeletonArrow_h__
...
class CSkeletonArrow : public CWeapon
{
private:
	explicit CSkeletonArrow(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CSkeletonArrow();
...
public:
	static CSkeletonArrow* Create(LPDIRECT3DDEVICE9 pGraphicDev);

private:
	virtual void Free() override;
};

#endif // SkeletonArrow_h__
