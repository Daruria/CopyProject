#ifndef SkeletonSword_h__
#define SkeletonSword_h__
...
class CSkeletonSword : public CWeapon
{
private:
	explicit CSkeletonSword(LPDIRECT3DDEVICE9 pGraphicDev);
	virtual ~CSkeletonSword();
...
public:
	static CSkeletonSword* Create(LPDIRECT3DDEVICE9 pGraphicDev);

private:
	virtual void Free() override;
};

#endif // SkeletonSword_h__
