...
void CAnimatedObject::LateUpdate()
{
	...
	//D3DXMatrixTranslation(&matTrans, m_tInfo.vPos.x - m_pView->GetScrollPos(0), m_tInfo.vPos.y - m_pView->GetScrollPos(1), m_tInfo.vPos.z);
...
CAnimatedObject * CAnimatedObject::Create(const wstring & wstrObjectKey, const wstring & wstrStateKey, const WORD iCnt, const D3DXVECTOR3 & vPos, 
	...
	RENDER_TYPE eType /*= RENDER_OBJECT*/, CToolView* pView /*= nullptr*/)
{
